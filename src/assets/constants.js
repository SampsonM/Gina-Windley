export const projects = [
  ...
  {
    name: "Sk-Eye",
    description: 'My winning design for an outdoor classroom on the site at the Centre for Alternative Technology. Of the three briefs set for the design and build project, two are situated by the pond outside of the Sheppard Theatre of the WISE building. The briefs are intended to be for educational by the public and staff on the CAT site. The pond, a viewing platform and observation area for its wildlife. The outdoor classroom; an education space to run alongside the barrel classrooms, to provide an undercover area for up to fifteen people to occupy. It should be memorable and demonstrate sustainable building methods and technologies, highlight activity and allow visitors to observe classes taking place and exhibit information on classes and workshops. The budget for each project is £1,000. The site needed a beacon for visitors to seek out and observe the classes and wildlife. The designs needed to be practical but also beautiful, an art piece still has a function even when classes are not being held. The proposed scheme focuses on  creating a relationship on site, with the sky and the water. It will encourage visitors to stop, experience the pond and observe the classes in the barrel classroom and Observation Oculus. The outdoor classroom pavilion draws the public in to converse with students and observe what they are learning. It instigates interaction and recording of the classes, using a blackboard painted interior. Visitors can observe notes and sketches from past students or see timetables for up and coming classes and events. ',
    images: [
      {
      ...
      },
      {
        ...
        link: "/project",
        alt: "Sk-Eye exploded diagram",
        section: "Sk-Eye"
      },
    ]
  },
  {
    name: "Northumberland Outward Bounds",
    description: `Resting alongside Hadrian’s Wall, the scheme is influenced by the dominating linearity and abstract forms of the Whin Sill and surrounding agricultural landscape and architecture.
    The new visitor centre and youth hostel facility at Steel Rigg celebrates the crags and the local landscape and raises awareness and respect for the outdoor activities in the area, particularly climbing. The centre will aim to educate people on climbing through both indoor and outdoor climbing walls.
    The Northumberland Outward Bounds Centre will become a place for the public to visit and learn about destinations and many activities within the National Park. The visitor centre form and layout is influenced by the local agricultural architecture and the verticality of the crags. The buildings are split up into a collection of buildings which evoke a welcoming and secure atmosphere.
    The accommodation cabins scatter the landscape replicating the Milecastes along Hadrian’s Wall. The Climbing and Viewing tower will provide climbing educational opportunities to visitors and spectacular views of the surrounding landscape.
    With the potential to attract a significant number of visitors from the landscape the tower will become a beacon and connect the building to area, attracting visitors from all around.`,
    images: [
      {
        ...
        link: "/project",
        section: "Northumberland Outward Bounds",
        alt: "Northumberland Outward Bounds Cross section",
      },
      {
        ...
        link: "/project",
        section: "Northumberland Outward Bounds",
        alt: "Northumberland Outward Bounds Exploded diagram",
      },
      {
        ...
        link: "/project",
        section: "Northumberland Outward Bounds",
        alt: "Northumberland Outward Bounds Model",
      },
      {
        ...
        link: "/project",
        section: "Northumberland Outward Bounds",
        alt: "Northumberland Outward Bounds Site plan",
      }
    ]
  },
  {
    ...
    images: [
      {
        URL: "./building/1.jpg",
        link: "/project",
        alt: "donated house roof tiling",
        section: "Donated House",
        isLocalImg: true,
      },
    ]
  },
  {
    name: 'Ghana eARThouse',
    images: [
      {
        ...
        link: "/project",
        alt: "Ghana rammed earth formwork",
        section: "Ghana eARThouse",
      },
      {
